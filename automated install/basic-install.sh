...
get_download_url() {
    ...
    case "$arch" in
        x86_64)
	    download_url="https://gitlab.com/yvelon/pihole-FTL-alpine/-/package_files/117951931/download";;
        i686)
	    download_url="https://gitlab.com/yvelon/pihole-FTL-alpine/-/package_files/117951938/download";;
        armv7l)
	    download_url="https://gitlab.com/yvelon/pihole-FTL-alpine/-/package_files/117951933/download";;
	aarch64)
	    download_url="https://gitlab.com/yvelon/pihole-FTL-alpine/-/package_files/117951936/download";;
        *)
            download_url="";;
   esac
   echo "$download_url"
...
compile_ftl() {
    ...
    # Create abuild keys and build pihole-FTL, do not use -i because doas fails
    abuild-keygen -a
    abuild -F -r
...
main() {
    ...
    if [[ "${EUID}" -eq 0 ]]; then
        ...
        # Let the user know it must be run as sudo
        printf "  %b %s\\n" "${INFO}" "${str}"
